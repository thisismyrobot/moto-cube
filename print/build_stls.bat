...
echo $fn = 100^; box_size = 100^; rotate([-90, 0, 0]) side_with_servo_mount_slot();^; >> side_with_servo_mount_slot.scad
...
echo $fn = 100^; box_size = 100^; rotate([90, 0, 0]) side_with_servo_rear_mount()^; >> side_with_servo_rear_mount.scad
